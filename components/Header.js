...
function Header() {
	...
	const  hiddenArticles = useSelector((state) => state.user.value);
	...
	const handleRegister = () => {
		fetch('https://morningnews-backend-opal.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morningnews-backend-opal.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
		...
		if (isModalVisible) {
			userSection =
				<div className={styles.headerIcons}>
					...
					<FontAwesomeIcon onClick={showModal} className={styles.userSection} icon={faEye} />
				</div>
		} else {
			userSection =
				<div className={styles.headerIcons}>
					<FontAwesomeIcon onClick={showModal} className={styles.userSection} icon={faUser} />
					<FontAwesomeIcon onClick={showHiddenArticles} className={styles.userSection} icon={faEye} />
				</div>
		}
	}
